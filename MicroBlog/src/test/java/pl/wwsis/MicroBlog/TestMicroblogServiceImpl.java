...
public class TestMicroblogServiceImpl {
	...
	public void TestShouldGetUserByLogin() {
		//when
		User testUser7 = microblogServiceImpl.registerUser("testowyLogin_7", "test7@test.com", "123pasS456ss", "Jan", "Kowalski", 'M', "1990-01-01");								
		...
		assertAll("testUserFromLogin", 
				...
				() -> assertEquals("123pasS456ss", testUserFromLogin.getPassword()),
	...
	public void TestShouldRegisterUser() {
		//when
		User testUser8 = microblogServiceImpl.registerUser("testowyLogin_8", "test8@test.com", "123pasS456ss", "Jan", "Kowalski", 'M', "1990-01-01");								
	...
	public void TestShouldAddFolloweeOfUser() {
		//when
		User testUser9 = microblogServiceImpl.registerUser("testowyLogin_9", "test9@test.com", "123pasS456ss", "Jan", "Kowalski", 'M', "1990-01-01");								
		User testUser10 = microblogServiceImpl.registerUser("testowyLogin_10", "test10@test.com", "123pasS456ss", "Jan", "Kowalski", 'M', "1990-01-01");								
