...
CREATE TABLE Post (id integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1), authorId integer NOT NULL, content varchar(4000) NOT NULL, isPublic bit, PRIMARY KEY (id));
CREATE TABLE "User" (id integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1), login varchar(200) NOT NULL, email varchar(200) NOT NULL, password varchar(100) NOT NULL, firstName varchar(200), lastName varchar(200), gender char(1), dob date, statusId char(1) ,PRIMARY KEY (id));
