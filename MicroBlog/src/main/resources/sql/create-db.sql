...
CREATE TABLE "User" (id integer GENERATED BY DEFAULT AS IDENTITY (START WITH 1), name varchar(200), email varchar(200), password varchar(100), firstName varchar(200), lastName varchar(200), gender char(1), dob date, PRIMARY KEY (id));
